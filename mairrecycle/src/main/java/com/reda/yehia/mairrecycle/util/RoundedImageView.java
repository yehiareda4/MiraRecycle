...
public class RoundedImageView extends ImageView {
    ...
    private void updateDrawable() {
        ...
        ((RoundedCornerDrawable) mDrawable).setBorderWidth(mBorderWidth);
        ((RoundedCornerDrawable) mDrawable).setBorderColor(mBorderColor);
        ((RoundedCornerDrawable) mDrawable).setOval(isOval);
    }
