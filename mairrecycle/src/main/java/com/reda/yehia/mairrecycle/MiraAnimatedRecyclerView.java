...
public class MiraAnimatedRecyclerView extends RecyclerView {
    ...
    public MiraAnimatedRecyclerView(Context context, int orientation, boolean reverse,
    ...
    public void setUp(Context context,int orientation, boolean reverse,
                                    int animationDuration, int layoutManagerType, int columns,
                                    int animation, LayoutAnimationController animationController) {
    ...
    public MiraAnimatedRecyclerView(Context context) {
        super(context);
        init(context, null);
    }

    public MiraAnimatedRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MiraAnimatedRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    @SuppressLint({"Recycle", "WrongConstant","CustomViewStyleable"})
    ...
    public static class Builder {
        ...
        public MiraAnimatedRecyclerView build() {
            return new MiraAnimatedRecyclerView(
